...
-I/usr/local/Cellar/freeglut/2.8.1/include
    -I $HOME/.brew/Cellar/glfw/3.2.1/include -I $HOME/.brew/Cellar/glew/2.1.0/include/ -I $HOME/.brew/Cellar/glm/0.9.9.0/include/ -I $HOME/.brew/Cellar/freeglut/3.0.0/include -I $HOME/.brew/Cellar/freeglut/3.0.0/include -I $HOME/.brew/Cellar/freetype/2.9.1/include/freetype2/ -I $HOME/.brew/Cellar/assimp/4.1.0/include/
